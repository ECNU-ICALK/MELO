...
axs[1,1].plot(t, UP[1], label = '$VecDB = [2]$',linewidth=1.8,color=colors[1])
axs[1,1].plot(t, UP[2], label = '$VecDB = [4]$',linewidth=1.8,color=colors[2])
...
plt.savefig('ablation_res/T5Small_zsre_block.jpg')
