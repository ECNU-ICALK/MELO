...
base_dir = '../logs/paper'
settings = ['t5large_zsre_r2e10b4', 't5large_zsre_r2e15b4', 't5large_zsre_r2e20b4']
...
axs[1,1].plot(t, UP[0], label = '$R$ = 1.0',linewidth=1.8,color=colors[0])
axs[1,1].plot(t, UP[1], label = '$R$ = 6.0',linewidth=1.8,color=colors[1])
axs[1,1].plot(t, UP[2], label = '$R$ = 20.0',linewidth=1.8,color=colors[2])
...
plt.savefig('ablation_res/T5Large_zsre_eps.jpg')
