...
base_dir = '../logs/paper'
settings = ['t5large_zsre_r2e10b0', 't5large_zsre_r2e10b0', 't5large_zsre_r2e10b0']
...
axs[1,0].yaxis.set_major_locator(MultipleLocator(3))
axs[1,0].set_xlabel('Edits',fontweight='bold',family = 'serif')
axs[1,0].set_ylabel('Time (mins)',fontweight='bold',family = 'serif')
axs[1,0].grid(True)


axs[1,1].plot(t, UP[0], label = '$VecDB$ = [0]',linewidth=1.8,color=colors[0])
axs[1,1].plot(t, UP[1], label = '$VecDB$ = [4]',linewidth=1.8,color=colors[1])
axs[1,1].plot(t, UP[2], label = '$vecDB$ = [10]',linewidth=1.8,color=colors[2])
...
plt.savefig('ablation_res/T5Large_zsre_block.jpg')
