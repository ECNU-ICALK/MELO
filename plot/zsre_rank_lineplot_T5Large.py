...
axs[2].set_ylabel('Time (min)',fontweight='bold',family = 'serif')
axs[2].grid(True)


axs[3].plot(t, UP[0], label = 'Partial Rank = 1',linewidth=1.8,color=colors[0])
axs[3].plot(t, UP[1], label = 'Partial Rank = 2',linewidth=1.8,color=colors[1])
axs[3].plot(t, UP[2], label = 'Partial Rank = 4',linewidth=1.8,color=colors[2])
...
plt.savefig('plotres/T5Large_zsre_rank.jpg')
